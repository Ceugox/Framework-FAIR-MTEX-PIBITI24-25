...
[grains, ebsd_Cu.grainId] = calcGrains(ebsd_Cu, 'angle', 10*degree);
...
gB_high = gB_high(gB_high.misorientation.angle > 10*degree);
plot(gB_high, 'lineColor', 'black', 'linewidth', 2);

title('Mapa de Contornos (Vermelho: 2-10° | Preto: >10°)');
hold off;
